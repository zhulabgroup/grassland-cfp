...
```{r plot-site-climate, fig.cap="Climate change in observational sites. Mean annual temperature and precipitation extracted from CHELSA. Trends are summarized by regression lines, solid p < 0.05, dashed p > 0.05."}
