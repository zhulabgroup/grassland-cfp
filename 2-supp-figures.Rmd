...
```{r cfp-climate, fig.width=12, fig.height=8}
...
```{r data-avail, fig.width=10, fig.height=10*.618}
...
```{r obs-site-climate, fig.width=11, fig.height=11*1.5}
...
```{r occ-data, fig.width=10, fig.height=7, eval=FALSE}
...
```{r clim-data, fig.width=10, fig.height=10}
...
```{r tmp-niche, fig.width=7, fig.height=7}
...
```{r cool-sp, fig.width=8, fig.height=8*.618}
...
```{r warm-sp, fig.width=8, fig.height=8*.618}
...
```{r gainloss-obs, fig.width=12, fig.height=10}
...
```{r gainloss-exp, fig.width=12, fig.height=18}
...
```{r guild-niche, fig.width=12, fig.height=5}
...
```{r guild-obs, fig.width=11, fig.height=11*1.5}
...
```{r guild-exp, fig.width=11, fig.height=11*1.5}
...
```{r cwd-niche, fig.width=12, fig.height=5}
...
```{r cwd-obs, fig.width=11, fig.height=11*1.5}
...
```{r cwd-exp-warm, fig.width=10, fig.height=6.18 /2 *3}
...
```{r cwd-exp-water, fig.width=10, fig.height=6.18 /2 *3}
...
```{r exp-water, fig.width=10, fig.height=6.18}
...
```{r exp-mclexp, fig.width=11, fig.height=8}
...
```{r exp-scide, fig.width=11, fig.height=8}
