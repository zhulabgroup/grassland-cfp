...
```{r occ-data-fig, fig.width=10, fig.cap="Occurrence data comparison from multiple sources (BIEN, eJepson (CCH), GBIF, iNaturalist) in CFP. Randomly showing 10% of data points to avoid overplotting."}
occ_comp_gg
rm(list = ls())
```
