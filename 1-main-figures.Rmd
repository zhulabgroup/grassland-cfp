...
JRGCE warming experiment, with `r n_plt["ambient"]` ambient plots and `r n_plt["warming"]` warming plots, to CTI and CPI comparisons. Read in niche and experimental data. Side-by-side boxplots to compare CTI and CPI from ambient vs. warming treatments.
