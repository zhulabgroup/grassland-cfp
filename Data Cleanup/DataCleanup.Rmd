...
Angelo <- read.csv("Angelo_CommCompData.csv") %>%
  filter(TMT == "C") %>%
  gather("Dan":"Thistle", key = species, value = cover)
names(Angelo) <- tolower(names(Angelo))

Angelo_spp <- read.csv("Angelo_spp_guilds.csv")
...
```{r Check that species IDs and guilds are correct, echo=FALSE}
Angelo_spp_check <- Angelo_species %>%
...
```{r Angelo  Graph Prep & graphing, warning=FALSE, include=FALSE}
Angelo_rich  <- Angelo_species %>%
  filter(cover > 0) %>%
  group_by(year) %>%
  summarize(rich = n_distinct(species.name))

ggplot(Angelo_rich, aes (x = year,  y = rich)) +
  geom_line () +
  geom_point() +
  ...
  scale_x_continuous(breaks= seq(1983, 2015, 1))
...
carrizo_spp <- read.csv("Carrizo_plant list.csv")
carrizo <- read.csv("Carrizo_data.csv")
carrizo_forms <- read.csv("Carrizo_plant forms.csv")
carrizo_extras <- read.csv("carrizo_extraspecies.csv")
...
```{r Carrizo spp check, echo=FALSE}
...
```{r Carrizo Graph Prep & graphing, warning=FALSE, include=FALSE}
## creating a dataframe for the richness data
carrizo_rich  <- carrizo_data %>%
  filter(guild != "moss",
           guild != "litter",
           guild != "bare",
           guild != "hole") %>%
...
## preparing the richness graph
ggplot(carrizo_rich, aes (x = year,  y = meanrich)) +
  geom_line () +
  geom_point() +
...
## showing all of the species in the plots
unique(carrizo$Species.Name)
```

```{r Removing extra carrizo objects}
remove(carrizo)
...
setwd("C:/Users/zeven_000/Desktop/UCSC/2019 - (2) Spring/LTD Chapter/Elkhorn/Old Data")

elkspp <- read.csv("ElkhornSpecies.csv")
elkspp$species.code <- tolower(elkspp$species.code)

elk_guilds <- read.csv("ElkhornGuilds.csv")
elk99 <- read.csv("Elk_1999.csv",  skip = 4)
elk00 <- read.csv("Elk_2000.csv", skip = 3)
elk01 <- read.csv("Elk_2001.csv", skip = 3)
elk02 <- read.csv("Elk_2002.csv", skip = 3)
elk03 <- read.csv("Elk_2003.csv")
elk04 <- read.csv("Elk_2004.csv")
elk05 <- read.csv("Elk_2005.csv")
elk06 <- read.csv("Elk_2006.csv")
elk07 <- read.csv("Elk_2007.csv")
elk08 <- read.csv("Elk_2008.csv")
elk09 <- read.csv("Elk_2009.csv")
elk10 <- read.csv("Elk_2010.csv", skip = 1)
elk11 <- read.csv("Elk_2011.csv")
elk12 <- read.csv("Elk_2012.csv")
elk13 <- read.csv("Elk_2013.csv", skip = 2)
elk14 <- read.csv("Elk_2014.csv", skip = 1)
elk15 <- read.csv("Elk_2015.csv", skip = 1)
elk16 <- read.csv("Elk_2016.csv", skip = 1)
elk17 <- read.csv("Elk_2017.csv", skip = 1)
elk18 <- read.csv("Elk_2018.csv", skip = 1)
...
setwd("C:/Users/zeven_000/Desktop/UCSC/2019 - (2) Spring/LTD Chapter/Jasper")
Jasper_Veg <- read.csv("JR_cover_forJosie.csv") %>%
  select(-X) %>%
  spread(key = species, value = cover) %>%
  replace(is.na(.), 0) %>%
  gather("aghe":"vumi", key = species, value = cover) %>%
  group_by(trtrep, year, species) %>%
  summarize(cover = mean(cover))

JR_spp <- read.csv("JR_speciesnames2.csv")

Jasper <- left_join(Jasper_Veg, JR_spp, by = "species")

Jasper_species <- Jasper %>%
  select("trtrep", "year", "species.name", "cover", "guild") %>%
  mutate(site = "Jasper") %>%
  filter(cover > 0)
...
```{r Jasper Graph Prep & graphing, warning=FALSE, include=FALSE}
Jasp_Richness  <- Jasper_species %>%
  group_by(year) %>%
  summarize(rich = n_distinct(species.name))

ggplot(Jasp_Richness, aes (x = year,  y = rich)) +
  geom_line () +
  geom_point() +
  labs(title = "Species Richness over time \n Jasper Ridge",
       y = "Species Richness",
...
unique(Jasper_species$species.name)
```
...
setwd("C:/Users/zeven_000/Desktop/UCSC/2019 - (3) Summer/LTD Chapter/McLaughlin")

## importing the data
McLAnn <- read.csv("Core_Community_Data2019.csv")
McL_Sites <- read.csv("AbioticSiteData.csv") %>%
  rename(Site = site)
McL_spp <- read.csv("McLaughlin_FunctionalGroups.csv")
...
## importing the data
McLSerp <- read.csv("Core_Community_Data2019.csv")
McL_Sites <- read.csv("AbioticSiteData.csv") %>%
  rename(Site = site)
McL_spp <- read.csv("McLaughlin_FunctionalGroups.csv") 
...
setwd("C:/Users/zeven_000/Desktop/UCSC/2019 - (3) Summer/LTD Chapter/Holl Datasets/Old Data")

Swanspp <- read.csv("ElkhornSpecies.csv")
Swanspp$species.code <- tolower(Swanspp$species.code)
Swan_guilds <- read.csv("ElkhornGuilds.csv")

Swan99 <- read.csv("Elk_1999.csv",  skip = 4)
Swan00 <- read.csv("Elk_2000.csv", skip = 3)
Swan01 <- read.csv("Elk_2001.csv", skip = 3)
Swan02 <- read.csv("Elk_2002.csv", skip = 3)
Swan03 <- read.csv("Elk_2003.csv")
Swan04 <- read.csv("Elk_2004.csv")
Swan05 <- read.csv("Elk_2005.csv")
Swan06 <- read.csv("Elk_2006.csv")
Swan07 <- read.csv("Elk_2007.csv")
Swan08 <- read.csv("swanton_08.csv", skip = 1)
Swan09 <- read.csv("Elk_2009.csv")
Swan10 <- read.csv("Elk_2010.csv", skip = 1)
Swan11 <- read.csv("Elk_2011.csv")
Swan12 <- read.csv("Elk_2012.csv")
...
UCSCspp <- read.csv("ElkhornSpecies.csv")
UCSCspp$species.code <- tolower(UCSCspp$species.code)
UCSC_guilds <- read.csv("ElkhornGuilds.csv")

UCSC99 <- read.csv("Elk_1999.csv",  skip = 4)
UCSC00 <- read.csv("Elk_2000.csv", skip = 3)
UCSC01 <- read.csv("Elk_2001.csv", skip = 3)
UCSC02 <- read.csv("Elk_2002.csv", skip = 3)
UCSC03 <- read.csv("Elk_2003.csv")
UCSC04 <- read.csv("Elk_2004.csv")
UCSC05 <- read.csv("Elk_2005.csv")
UCSC06 <- read.csv("Elk_2006.csv")
UCSC07 <- read.csv("Elk_2007.csv")
UCSC08 <- read.csv("ucsc_08.csv")
UCSC09 <- read.csv("Elk_2009.csv")
UCSC10 <- read.csv("Elk_2010.csv", skip = 1)
UCSC11 <- read.csv("Elk_2011.csv")
UCSC12 <- read.csv("Elk_2012.csv")
```
...
# Basic Plots of all sites  
  
## Across-site Species Richness 
Now that all of our data is cleaned and ready for preliminary analysis, I can compare across sites with a few quick graphs. First, I am interested in how species richness compares across all sites. 

```{r Making a single dataframe, warning = FALSE, echo = FALSE}

# Angelo avg plot-level richness
Angelo_rich <- Angelo %>%
  ...
  group_by(year) %>%
  summarise(meanrich = mean(rich),
            richerr = std.error(rich)) %>%
  mutate(site = "Angelo")

# Carrizo avg plot-level richness
carrizo_rich <- carrizo %>%
...
# Elkhorn plot-level richness
elkhorn_rich <- elk_99_18 %>%
  filter(intercepts > 0,
         species.name != "moss" &
           species.name != "dung" &
           species.name != "thatch" &
  ...
  summarise(meanrich = mean(rich),
            richerr = std.error(rich)) %>%
  mutate(site = "Elkhorn")
elkhorn_rich$year <- as.integer(elkhorn_rich$year)

# Swanton plot-level richness
swanton_rich <- Swan_99_12 %>%
  filter(intercepts > 0,
         species.name != "moss" &
           species.name != "dung" &
           species.name != "thatch" &
  ...
  summarise(meanrich = mean(rich),
            richerr = std.error(rich)) %>%
  mutate(site = "Swanton")
swanton_rich$year <- as.integer(swanton_rich$year)

# UCSC plot-level richness
UCSC_rich <- UCSC_99_12 %>%
  filter(intercepts > 0,
         species.name != "moss" &
           species.name != "dung" &
           species.name != "thatch" &
  ...
  summarise(meanrich = mean(rich),
            richerr = std.error(rich)) %>%
  mutate(site = "UCSC")
UCSC_rich$year <- as.integer(UCSC_rich$year)

# McLaughlin Annual plot-level richness
McLAnn_rich <- McLAnn %>%
  filter(Species_Name != "Bare" &
           Species_Name != "Rock") %>%
  group_by(Year, plot) %>%
  ...
  summarise(meanrich = mean(rich),
            richerr = std.error(rich)) %>%
  mutate(site = "McL Annual") %>%
  rename(year = Year)

#McLaughlin Serpentine plot-level richness
McLSerp_rich <- McLSerp %>%
  filter(Species_Name != "Bare" &
           Species_Name != "Rock") %>%
  group_by(Year, plot) %>%
  ...
  summarise(meanrich = mean(rich),
            richerr = std.error(rich)) %>%
  mutate(site = "McL Serpentine") %>%
  rename(year = Year)

# Jasper plot-level richness
Jasper_rich <- Jasper %>%
  filter(cover > 0) %>%
...
## adding to a single dataframe
rich_data <- bind_rows(Angelo_rich, carrizo_rich, Jasper_rich, McLSerp_rich,
                       McLAnn_rich, UCSC_rich, swanton_rich, elkhorn_rich)

```

```{r Making the graph for overall species richness, warning = FALSE, echo = FALSE}

## making a graph
rich_graph <- ggplot(rich_data, aes (x = year,  y = meanrich)) +
  geom_line (aes(group = site, color = site)) +
  geom_point(aes(color = site, shape = site)) +
  geom_errorbar(aes(ymin = meanrich-richerr, ymax = meanrich+richerr, 
                    group = site), width=0.2) +
  labs(title = "Average plot species richness over time \n 8 sites",
       y = "Species Richness",
       x = "Year") +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
  ...
  coord_cartesian(ylim = c(0, 35)) +
  scale_y_continuous(breaks = seq(0, 35, 5), expand = c(0,0)) +
  scale_x_continuous(breaks= seq(1983, 2018, 2))
...
Apart from the McLaughlin sites (blue), there doesn't appear to be a trend in declining species richness statewide. While we can't compare sites to one another, no one line appears to be declining. 

## Guild Richness
### Angelo

```{r Angelo Guild-level richness dataframe, echo = FALSE}

# Angelo avg guild-level richness
Angelo_rich <- Angelo %>%
  filter(guild != "Litter" &
           guild != "Bare" &
           guild != "Moss") %>%
  group_by(plot, year, guild) %>%
  summarise(rich = n_distinct(species.name)) %>%
  group_by(year, guild) %>%
  summarise(meanrich = mean(rich),
            richerr = std.error(rich)) %>%
...
```{r Angelo Guild-level richness graph, warning=FALSE, echo = FALSE}
Angelo_guild_graph <- ggplot(Angelo_rich, aes (x = year,  y = meanrich)) +
  geom_line (aes(group = guild, color = guild)) +
  geom_point(aes(color = guild, shape = guild)) +
  geom_errorbar(aes(ymin = meanrich-richerr, ymax = meanrich+richerr, 
                    group = guild), width=0.2) +
  labs(title = "Average plot guild richness over time \n Angelo",
       y = "Species Richness",
       x = "Year") +
  theme(axis.line = element_line(colour = "black"),
        panel.grid.major = element_blank(),
...
```{r Carrizo Guild-level richness dataframe, echo = FALSE}

# Carrizo avg guild-level richness
carrizo_rich <- carrizo %>%
  filter(Species.Name != "moss" &
           Species.Name != "hole" &
           Species.Name != "litter" &
...
```{r Carrizo Guild-level richness graph, warning=FALSE, echo = FALSE}
carrizo_guild_graph <- ggplot(carrizo_rich, aes (x = year,  y = meanrich)) +
  geom_line (aes(group = guild, color = guild)) +
  geom_point(aes(color = guild, shape = guild)) +
  geom_errorbar(aes(ymin = meanrich-richerr, ymax = meanrich+richerr, 
                    group = guild), width=0.2) +
...
```{r Elkhorn Guild-level richness dataframe, echo = FALSE}
...
```{r Elkhorn Guild-level richness graph, warning=FALSE, echo = FALSE}
elkhorn_guild_graph <- ggplot(elkhorn_rich, aes (x = year,  y = meanrich)) +
  geom_line (aes(group = guild, color = guild)) +
  geom_point(aes(color = guild, shape = guild)) +
  geom_errorbar(aes(ymin = meanrich-richerr, ymax = meanrich+richerr, 
                    group = guild), width=0.2) +
...
**The result of this graph reminds me that I need to convert all "NPGr" (grammoids) to "NPG" with the grasses if we are going to group them as the same guild.**
