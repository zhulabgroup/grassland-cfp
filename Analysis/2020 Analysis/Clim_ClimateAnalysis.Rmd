...
# swanton
hist(all.CTI.wtryr[all.CTI.wtryr$site == "Swanton",]$precip)
summary(lm(precip ~ year,
...
# angelo
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "Angelo",]))

# carrizo
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "Carrizo",]))

# elkhorn
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "Elkhorn",]))

# jasper
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "Jasper",]))

# mcL ann
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "McL Ann",]))

# mcL serp
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "McL Serp",]))

# swanton
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "Swanton",]))
# ucsc
summary(lm(precip ~ year,
                    data = win.ppt[win.ppt$site == "UCSC",]))

ggplot(win.ppt, aes(x = year, y = precip)) +
