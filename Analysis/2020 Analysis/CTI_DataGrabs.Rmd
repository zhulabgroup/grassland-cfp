...
ang_species_data <- occ(query = ang_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
...
ang_trifolium_data <- occ(query = ang_trifolium, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
car_species_data <- occ(query = car_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
car_allium_data <- occ(query = car_allium, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
car_allium_data_df <- car_allium_data_df %>%
  mutate(species.name = "Carrizo Allium sp.")
...
car_astragalus_data <- occ(query = car_astragalus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
car_astragalus_data_df <- car_astragalus_data_df %>%
  mutate(species.name = "Car Astragalus sp.")
...
car_delpinium_data <- occ(query = car_delpinium, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
elk_species_data <- occ(query = elk_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
elk_bromus_data <- occ(query = elk_bromus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
elk_brassica_data <- occ(query = elk_brassica, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
jasp_species_data <- occ(query = jasp_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
jasp_brodiaea_data <- occ(query = jasp_brodiaea, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
jasp_trifolium_data <- occ(query = jasp_trifolium, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLann_species_data <- occ(query = mcLann_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
...
mcLann_juncus_data <- occ(query = mcLann_juncus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLserp_species_data <- occ(query = mcLann_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLserp_juncus_data <- occ(query = mcLserp_juncus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLserp_astragalus_data <- occ(query = mcLserp_astragalus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLserp_astragalus_data_df <- mcLserp_astragalus_data_df %>%
  mutate(species.name = "mcLserp Astragalus sp.")
```
...
mcLserp_quercus_data <- occ(query = mcLserp_quercus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLserp_centaurea_data <- occ(query = mcLserp_centaurea, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLserp_allium_data <- occ(query = mcLserp_allium, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
mcLserp_allium_data_df <-mcLserp_allium_data_df %>%
  mutate(species.name = "mcLserp Allium sp.") 
```
...
swan_species_data <- occ(query = swan_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
swan_bromus_data <- occ(query = swan_bromus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
swan_rumex_data <- occ(query = swan_rumex, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
ucsc_species_data <- spocc::occ(query = ucsc_species_list, from = "gbif", has_coords = TRUE, limit = 25000,
                                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
ucsc_bromus_data <- occ(query = ucsc_bromus, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
ucsc_brassica_data <- occ(query = ucsc_brassica, from = "gbif", has_coords = TRUE, limit = 25000,
                gbifopts = list(hasGeospatialIssue = FALSE, country = "US",
                                stateProvince = "California"))
```
...
write_rds(ang_species_data_df, "Analysis/GBIF_Data/AngGBIF_080720.rds")
write_rds(car_species_data_df, "Analysis/GBIF_Data/CarGBIF_080720.rds")
write_rds(elk_species_data_df, "Analysis/GBIF_Data/ElkGBIF_080720.rds")
write_rds(jasp_species_data_df, "Analysis/GBIF_Data/JaspGBIF_080720.rds")
write_rds(mcLann_species_data_df, "Analysis/GBIF_Data/mcLannGBIF_080720.rds")
write_rds(mcLserp_species_data_df, "Analysis/GBIF_Data/mcLserpGBIF_080720.rds")
write_rds(swan_species_data_df, "Analysis/GBIF_Data/swanGBIF_080720.rds")
write_rds(ucsc_species_data_df, "Analysis/GBIF_Data/ucscGBIF_080720.rds")
```
