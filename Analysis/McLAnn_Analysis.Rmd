...
rich_glm <- glm(rich ~ year, ucsc_rich, family = poisson)
...
McLAnn.changerate <- rate_change_interval(McLAnn_byquad,
                                        time.var = "Year",
                                        species.var = "species.name",
                                        abundance.var = "relcov",
                                        replicate.var = "plot")

ggplot(McLAnn.changerate, aes(interval, distance, color = plot)) + 
