...
Species occurrence in climate space of mean annual temperature (°C), annual precipitation (mm), and annual climate water deficit (mm) retrieved from the TerraClimate data (gray). Each point corresponds to a GBIF occurrence location. We highlight two example species _Danthonia californica_ associated with cooler and wetter locations (blue) and _Stipa pulchra_ associated with warmer and drier locations (red).
