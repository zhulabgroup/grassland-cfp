...
elkspp <- read.csv("Data and Data Cleanup/HollData/ElkhornSpecies.csv")
elkspp$species.code <- tolower(elkspp$species.code)

elk_guilds <- read.csv("Data and Data Cleanup/HollData/ElkhornGuilds.csv")
elk99 <- read.csv("Data and Data Cleanup/HollData/Elk_1999.csv",  skip = 4)
elk00 <- read.csv("Data and Data Cleanup/HollData/Elk_2000.csv", skip = 3)
elk01 <- read.csv("Data and Data Cleanup/HollData/Elk_2001.csv", skip = 3)
elk02 <- read.csv("Data and Data Cleanup/HollData/Elk_2002.csv", skip = 3)
elk03 <- read.csv("Data and Data Cleanup/HollData/Elk_2003.csv")
elk04 <- read.csv("Data and Data Cleanup/HollData/Elk_2004.csv")
elk05 <- read.csv("Data and Data Cleanup/HollData/Elk_2005.csv")
elk06 <- read.csv("Data and Data Cleanup/HollData/Elk_2006.csv")
elk07 <- read.csv("Data and Data Cleanup/HollData/Elk_2007.csv")
elk08 <- read.csv("Data and Data Cleanup/HollData/Elk_2008.csv")
elk09 <- read.csv("Data and Data Cleanup/HollData/Elk_2009.csv")
elk10 <- read.csv("Data and Data Cleanup/HollData/Elk_2010.csv", skip = 1)
elk11 <- read.csv("Data and Data Cleanup/HollData/Elk_2011.csv")
elk12 <- read.csv("Data and Data Cleanup/HollData/Elk_2012.csv")
elk13 <- read.csv("Data and Data Cleanup/HollData/Elk_2013.csv", skip = 2)
elk14 <- read.csv("Data and Data Cleanup/HollData/Elk_2014.csv", skip = 1)
elk15 <- read.csv("Data and Data Cleanup/HollData/Elk_2015.csv", skip = 1)
elk16 <- read.csv("Data and Data Cleanup/HollData/Elk_2016.csv", skip = 1)
elk17 <- read.csv("Data and Data Cleanup/HollData/Elk_2017.csv", skip = 1)
elk18 <- read.csv("Data and Data Cleanup/HollData/Elk_2018.csv", skip = 1)
...
Swanspp <- read.csv("Data and Data Cleanup/HollData/ElkhornSpecies.csv")
Swanspp$species.code <- tolower(Swanspp$species.code)
Swan_guilds <- read.csv("Data and Data Cleanup/HollData/ElkhornGuilds.csv")

Swan99 <- read.csv("Data and Data Cleanup/HollData/Elk_1999.csv",  skip = 4)
Swan00 <- read.csv("Data and Data Cleanup/HollData/Elk_2000.csv", skip = 3)
Swan01 <- read.csv("Data and Data Cleanup/HollData/Elk_2001.csv", skip = 3)
Swan02 <- read.csv("Data and Data Cleanup/HollData/Elk_2002.csv", skip = 3)
Swan03 <- read.csv("Data and Data Cleanup/HollData/Elk_2003.csv")
Swan04 <- read.csv("Data and Data Cleanup/HollData/Elk_2004.csv")
Swan05 <- read.csv("Data and Data Cleanup/HollData/Elk_2005.csv")
Swan06 <- read.csv("Data and Data Cleanup/HollData/Elk_2006.csv")
Swan07 <- read.csv("Data and Data Cleanup/HollData/Elk_2007.csv")
Swan08 <- read.csv("Data and Data Cleanup/HollData/swanton_08.csv", skip = 1)
Swan09 <- read.csv("Data and Data Cleanup/HollData/Elk_2009.csv")
Swan10 <- read.csv("Data and Data Cleanup/HollData/Elk_2010.csv", skip = 1)
Swan11 <- read.csv("Data and Data Cleanup/HollData/Elk_2011.csv")
Swan12 <- read.csv("Data and Data Cleanup/HollData/Elk_2012.csv")
...
UCSCspp <- read.csv("Data and Data Cleanup/HollData/ElkhornSpecies.csv")
UCSCspp$species.code <- tolower(UCSCspp$species.code)
UCSC_guilds <- read.csv("Data and Data Cleanup/HollData/ElkhornGuilds.csv")

UCSC99 <- read.csv("Data and Data Cleanup/HollData/Elk_1999.csv",  skip = 4)
UCSC00 <- read.csv("Data and Data Cleanup/HollData/Elk_2000.csv", skip = 3)
UCSC01 <- read.csv("Data and Data Cleanup/HollData/Elk_2001.csv", skip = 3)
UCSC02 <- read.csv("Data and Data Cleanup/HollData/Elk_2002.csv", skip = 3)
UCSC03 <- read.csv("Data and Data Cleanup/HollData/Elk_2003.csv")
UCSC04 <- read.csv("Data and Data Cleanup/HollData/Elk_2004.csv")
UCSC05 <- read.csv("Data and Data Cleanup/HollData/Elk_2005.csv")
UCSC06 <- read.csv("Data and Data Cleanup/HollData/Elk_2006.csv")
UCSC07 <- read.csv("Data and Data Cleanup/HollData/Elk_2007.csv")
UCSC08 <- read.csv("Data and Data Cleanup/HollData/ucsc_08.csv")
UCSC09 <- read.csv("Data and Data Cleanup/HollData/Elk_2009.csv")
UCSC10 <- read.csv("Data and Data Cleanup/HollData/Elk_2010.csv", skip = 1)
UCSC11 <- read.csv("Data and Data Cleanup/HollData/Elk_2011.csv")
UCSC12 <- read.csv("Data and Data Cleanup/HollData/Elk_2012.csv")
```
...
```{r combine data}
elkhorn_data <- read.csv("Analysis/ComData/elkhorn_data_allplots.csv")
swanton_data <- read.csv("Analysis/ComData/swanton_data_allplots.csv")
ucsc_data <- read.csv("Analysis/ComData/ucsc_data_allplots.csv")
...
# combine
karen_rel_all <- full_join(rel_elk, rel_swan)
karen_rel_all <- full_join(rel_all, rel_ucsc)

karen_rel_all <- karen_rel_all %>%
...
```{r generate species list data}
karen_species <- unique(rel_all$species.name)
karen_species <- as.data.frame(karen_species)
karen_species$karen_species <- paste0("'", karen_species$karen_species, "',")
cat(format_delim(karen_species, delim = ""))
```

```{r call GBIF data}
karen_species_list <- c('Erodium botrys',
                      'Erodium moschatum',
                      'Geranium dissectum',
                      'Stellaria media',
...
karen_species_data <- occ(query = karen_species_list, from = "gbif", has_coords = TRUE, limit = 100000,
...
flags <- clean_coordinates(x = karen_species_data_df, lon = "longitude", lat = "latitude",
                          species = "name",
...
karen_species_data_df <- karen_species_data_df[flags$.summary,] %>%
...
karen_species_data_df <- full_join(karen_species_data_df, all_bromus_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_brassica_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_rumex_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_erigeron_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_carex_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_briza_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_madia_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_vicia_data_df)
karen_species_data_df <- full_join(karen_species_data_df, all_brodiaea_data_df)

# and we'll save the angelo gbif spatial data
write_rds(karen_species_data_df, "Analysis/GBIF_Data/AllKaren_GBIF.rds")
```
...
xy <- karen_species_data_df[,c("longitude","latitude")]
sp_xy <- karen_species_data_df[c("species.name", "longitude","latitude")]

env <- raster::getData('worldclim', var='bio', res=2.5)
...
karen_species_clim <- cbind(xy_bio, sp_xy) 

karen_species_clim <- karen_species_clim %>%
...
```{r rel and clim data join}
all_karen_CTI <- left_join(karen_rel_all, karen_species_clim, by = "species.name") 
...
```{r}
all_karen_CTI_raw <- read.csv("Analysis/CTI Data/All_Karen_08_2020.csv")


all_karen_CTI <- all_karen_CTI_raw %>%
  filter(species.name != "Dung",
         species.name != "Oxalis pilosa",
         freq != "CLA", freq != "CLB", freq != "CLC", freq != "NM", freq != "CL2", freq != "CL3") %>%
  group_by(site, year, plot, freq, treat) %>%
  mutate(relCTI = relcov*meanT,
         relCPI = relcov*meanp) %>%
  summarise(plotCTI = sum(relCTI),
            plotCPI = sum(relCPI)) %>%
  mutate(freq = recode_factor(freq,
                              "CL1" = "Clipped"))

CTI_plot_means <- all_karen_CTI %>%
  group_by(site, plot, freq, year) %>%
...
ggplot(CTI_site_means, aes(x = year, y = meanCTI)) +
  ...
  facet_wrap(site~freq, scales = "free", ncol = 3)
,
...
## linear models for change over time

```{r CTI MODELS}
CTI_models <- all_karen_CTI %>%
  mutate(year2 = year,
         # we rescale the year to improve the model and prevent eigenvalue warnings
         year = abs(year2-1998)) %>%
  unite(site, freq, col = "site", sep = "-")
CTI_models$year <- as.numeric(CTI_models$year)


# Elkhorn-Control
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "Elkhorn-Control",]))

# Elkhorn-Clipped
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "Elkhorn-Clipped",]))

# Elkhorn-Grazed
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "Elkhorn-Grazed",]))


# Swanton-Control
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "Swanton-Control",]))

# Swanton-Clipped
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "Swanton-Clipped",]))

# Swanton-Grazed
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "Swanton-Grazed",]))


# UCSC-Control
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "UCSC-Control",]))

# UCSC-Clipped
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "UCSC-Clipped",]))

# UCSC-Grazed
summary(glm(plotCTI ~ year,
              data = CTI_models[CTI_models$site == "UCSC-Grazed",]))

```

```{r CPI models}
# Elkhorn-Control
summary(glm(plotCPI ~ year,
              data = CTI_models[CTI_models$site == "Elkhorn-Control",]))
