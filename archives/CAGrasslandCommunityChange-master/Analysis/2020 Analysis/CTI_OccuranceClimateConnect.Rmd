...
rel_all <- read.csv("Analysis/ComData/AllData_Relative.csv") %>%
  dplyr::select(-X)
rel_all$species.name <- str_trim(rel_all$species.name)

ang_species_data_df <- read_rds("Analysis/GBIF_Data/AngGBIF_080720.rds")
car_species_data_df <- read_rds("Analysis/GBIF_Data/CarGBIF_080720.rds")
elk_species_data_df <- read_rds("Analysis/GBIF_Data/ElkGBIF_080720.rds")
jasp_species_data_df <- read_rds("Analysis/GBIF_Data/JaspGBIF_080720.rds")
mcLann_species_data_df <- read_rds("Analysis/GBIF_Data/mcLannGBIF_080720.rds")
mcLserp_species_data_df <- read_rds("Analysis/GBIF_Data/mcLserpGBIF_080720.rds")
swan_species_data_df <- read_rds("Analysis/GBIF_Data/swanGBIF_080720.rds")
ucsc_species_data_df <- read_rds("Analysis/GBIF_Data/ucscGBIF_080720.rds")
...
sp_xy <- all_spp_df %>%
  dplyr::select(species.name, longitude, latitude, key)
...
all_CTI <- read.csv("Analysis/CTI Data/AllSite_CTI_08_2020.csv")
```
