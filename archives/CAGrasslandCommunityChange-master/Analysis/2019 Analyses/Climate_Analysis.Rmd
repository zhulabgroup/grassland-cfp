...
all.CTI$site <- as.factor(all.CTI$site)
...
```{r plots, echo = FALSE}
ggplot(all.CTI.clim, aes(x = site2, y = tmean)) +
  geom_boxplot()  +
...
ggplot(all.CTI.clim) +
  geom_jitter(aes(x = site2, y = tmax), color = "red") +
  geom_jitter(aes(x = site2, y = tmin), color = "blue") +
  labs(x = "site",
...
ggplot(all.CTI.wtryr, aes(x = year, y = precip, color = site)) + geom_line()
...
ggplot(win.ppt, aes(x = year, y = precip, color = site2)) +
  geom_point(shape = 3) +
  geom_line() +
  labs(x = "Year",
       y = "Precip (mm)",
...
#graph
ggplot(wytmin, aes(x = year, y = tmin, color = site2)) +
  geom_point(shape = 3) +
  geom_line(aes(linetype = sig)) +
  labs(x = "Year",
