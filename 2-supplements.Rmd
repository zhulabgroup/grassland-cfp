...
```{r obs-ppt-tab}
obs_ppt_tbl %>%
  knitr::kable(caption = "Trends of mean annual precipitation (mm) across observational sites, reporting the linear slope estimate, standard error,  *p*-value, and significance level from *t*-test (ns: *p* > 0.05, $*$: *p* ≤ 0.05, $**$: *p* ≤ 0.01, $***$: *p* ≤ 0.001).")
rm(list = ls())
```
