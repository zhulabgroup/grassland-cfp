...
site_vec <- c(
  ...
  mclann = "McLaughlin Reserve Annual",
  mclserp = "McLaughlin Reserve Serpentine",
...
fig2_gg <- jrgce_gg +
  ...
  mclann_gg + mclserp_gg + swanton_gg + ucsc_gg +
  plot_annotation(tag_levels = "A") +
  plot_layout(design = "
  AAAA
  BCDE
