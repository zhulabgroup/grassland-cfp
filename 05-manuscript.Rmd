...
climate_file <- "data/climate/climate-gbif-2022-07-04.rds"
...
```{r}
gbif_chelsa_sf <- read_rds(climate_file) %>%
...
bien_tbl <- read_rds("data/occurrence/bien/bien-cfp-2022-04-27.rds") %>%
  ...
  dplyr::select(dataset, key, species, longitude, latitude)
...
```{r}
clim_gbif_tbl <- read_rds("data/climate/climate-gbif-2022-05-28.rds") %>%
  as_tibble()
