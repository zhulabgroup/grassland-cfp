...
obs_cti_gg <-
  ...
  facet_wrap(~site,
    nrow = 2,
    scales = "free_y",
    labeller = labeller(site = site_vec)
  ) +
  labs(
    x = NULL, # "Year",
...
```{r fig.cap="Climate data source comparison"}
...
TODO: correlation of mean, median, upper, lower temp and precip for all species are highly correlated

### Individual species climate niches

TODO: multi-page PDF, each for a single species (to avoid overplotting), left geo-space, right clim-space

### Experimental and observational site map

### JRGCE biomass vs. pin count data

TODO: show different measures of abundance (e.g., biomass, pin count) are highly correlated
