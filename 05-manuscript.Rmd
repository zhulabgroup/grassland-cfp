...
```{r}
cool_sp <- "Danthonia californica" # "Juncus bufonius"
warm_sp <- "Stipa pulchra" # "Festuca perennis"
...
species_color <- c(cool = "blue", other = gray(.9), warm = "red")
species_shape <- c(cool = 19, other = 20, warm = 19)
species_alpha <- c(cool = .6, other = .005, warm = .6)
...
ggsave(
  ...
  filename = str_c(
    "figures/fig1-",
    word(cool_sp, 1) %>% tolower(),
    "-",
    word(warm_sp, 1) %>% tolower(),
    ".png"
  ),
  width = 7.5,
  height = 7.5 * 1.618
