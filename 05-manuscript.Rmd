...
angelo_gg <- obs_idx_tbl %>%
  obs_gg_fun("angelo", cti_lab = "CTI (°C)", cpi_lab = "CPI (mm)")

carrizo_gg <- obs_idx_tbl %>%
  obs_gg_fun("carrizo")

elkhorn_gg <- obs_idx_tbl %>%
  obs_gg_fun("elkhorn")

jasper_gg <- obs_idx_tbl %>%
  obs_gg_fun("jasper")

mclann_gg <- obs_idx_tbl %>%
  obs_gg_fun("mclann", cti_lab = "CTI (°C)", cpi_lab = "CPI (mm)")

mclserp_gg <- obs_idx_tbl %>%
  obs_gg_fun("mclserp")

pleasantonridge_gg <- obs_idx_tbl %>%
  obs_gg_fun("pleasantonridge")

sunol_gg <- obs_idx_tbl %>%
  obs_gg_fun("sunol")

swanton_gg <- obs_idx_tbl %>%
  obs_gg_fun("swanton", cti_lab = "CTI (°C)", cpi_lab = "CPI (mm)")

ucsc_gg <- obs_idx_tbl %>%
  obs_gg_fun("ucsc")

vascocaves_gg <- obs_idx_tbl %>%
  obs_gg_fun("vascocaves")
```
