...
pacman::p_load(bookdown, flextable, GGally, ggpubr, ggtext, ggthemes, googledrive, markdown, raster, rmarkdown, rnaturalearth, terra, tidyverse, viridis, sf, patchwork)
