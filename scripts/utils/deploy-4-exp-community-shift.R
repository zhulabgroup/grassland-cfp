...
rmarkdown::render(
  input = "4-exp-community-shift.Rmd",
  output_format = "bookdown::word_document2",
  output_file = paste0(tempdir(), "/Experimental community shift analyses.docx")
  # knit_root_dir = ".." # set to project dir
)
googledrive::drive_put(
  media = paste0(tempdir(), "/Experimental community shift analyses.docx"),
