...
exp_com_tbl %>%
  filter(site == "jrgce") %>%
  mutate(treat_T = str_sub(treat, start = 1L, end = 1L)) %>%
  ggplot(aes(year, vpdmax_com_mean, col = treat_T, group = interaction(treat_T, year))) +
  geom_boxplot() +
  ggpubr::stat_compare_means(
    aes(group = treat_T),
    method = "wilcox.test",
...
exp_com_tbl %>%
  filter(site == "jrgce") %>%
  mutate(treat_T = str_sub(treat, start = 1L, end = 1L)) %>%
  ggplot(aes(year, sqrt(vpdmax_com_var), col = treat_T, group = interaction(treat_T, year))) +
  geom_boxplot() +
  ggpubr::stat_compare_means(
    aes(group = treat_T),
    method = "wilcox.test",
...
exp_com_tbl %>%
  ...
  ggplot(aes(year, tmean_com_mean, col = treat_P, group = interaction(treat_P, year))) +
  geom_boxplot() +
  ggpubr::stat_compare_means(
    aes(group = treat_P),
    method = "wilcox.test",
...
exp_com_tbl %>%
  filter(site == "jrgce") %>%
  mutate(treat_P = str_sub(treat, start = 2L, end = 2L)) %>%
  ggplot(aes(year, sqrt(tmean_com_var), col = treat_P, group = interaction(treat_P, year))) +
  geom_boxplot() +
  ggpubr::stat_compare_means(
    aes(group = treat_P),
    method = "wilcox.test",
