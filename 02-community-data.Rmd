...
angelo_data %>%
  write.csv("data/community/tidy/angelo_data.csv")
```
...
carrizo_data %>%
  write.csv("data/community/tidy/carrizo_data.csv")
```
...
elkhorn_data %>%
  write.csv("data/community/tidy/elkhorn_data.csv")
```
...
jasper_data %>%
  write.csv("data/community/tidy/jasper_data.csv")
```
...
mclann_data %>%
  write.csv("data/community/tidy/mclann_data.csv")
```
...
mclserp_data %>%
  write.csv("data/community/tidy/mclserp_data.csv")
```
...
swanton_data %>% 
  write.csv("data/community/tidy/swanton_data.csv")
...
ucsc_data %>% 
  write.csv("data/community/tidy/ucsc_data.csv")
...
Merging, making relative cover, and saving data files.
...
```{r, saving CSV}
write.csv(rel_all, "data/community/tidy/AllData_Relative.csv")
```
