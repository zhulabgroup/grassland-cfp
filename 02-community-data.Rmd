...
# ## importing the data
# saro_rich <- read.csv("data/community/raw/Santa Rosa/SantaRosa_Richness.csv")
# saro_cov <- read.csv("data/community/raw/Santa Rosa/SantaRosa_Cover00_06_raw.csv")
# saro_spp <- read.csv("data/community/raw/Santa Rosa/SantaRosa_SpeciesList.csv") %>%
