...
```{r}
(read_csv("data/community/tidy/jrgce.csv", col_types = "ciccccdc") %>%
...
```{r}
all_exp_data <- read_rds("data/community/all-experimental-data.rds")
all_obs_data <- read_rds("data/community/all-observational-data.rds")
...
Resolve duplicated/misspelling species names. First download using the taxize package. 
...
Then, choose match based on (conversation with Justin Luong, 2/15/22)
