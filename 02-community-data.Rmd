...
Separately save three site files.
...
site_sf <- tribble(
  ...
  "pleasantonridge", "Pleasanton Ridge Regional Park", "37 36 55.47384", "-121 53 4.4142", "???", "???",
  ...
  "sunol", "Sunol Regional Wilderness", "37 30 36.66", "-121 49 42.78", "???", "???",
  ...
  "vascocaves", "Vasco Caves Regional Preserve", "37 48 18", "121 41 13.2", "???", "???"
) %>%
  mutate(
