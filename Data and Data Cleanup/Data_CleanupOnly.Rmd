...
Angelo <- read.csv("Data and Data Cleanup/Angelo/Angelo_CommCompData.csv") %>%
  filter(TMT == "C") %>%
  gather("Dan":"Thistle", key = species, value = cover)
names(Angelo) <- tolower(names(Angelo))

Angelo_spp <- read.csv("Data and Data Cleanup/Angelo/Angelo_spp_guilds.csv")
...
carrizo_spp <- read.csv("Data and Data Cleanup/Carrizo/Carrizo_plant list.csv")
carrizo <- read.csv("Data and Data Cleanup/Carrizo/Carrizo_data.csv")
carrizo_forms <- read.csv("Data and Data Cleanup/Carrizo/Carrizo_plant forms.csv")
carrizo_extras <- read.csv("Data and Data Cleanup/Carrizo/carrizo_extraspecies.csv")
...
Jasper_Veg <- read.csv("Data and Data Cleanup/Jasper/JR_cover_forJosie.csv") %>%
  select(-X) %>%
...
JR_spp <- read.csv("Data and Data Cleanup/Jasper/JR_speciesnames2.csv")
...
## importing the data
McLAnn <- read.csv("Data and Data Cleanup/McLaughlin/Core_Community_Data2019.csv")
McL_Sites <- read.csv("Data and Data Cleanup/McLaughlin/AbioticSiteData.csv") %>%
  rename(Site = site)
McL_spp <- read.csv("Data and Data Cleanup/McLaughlin/McLaughlin_FunctionalGroups.csv")
...
## importing the data
McLSerp <- read.csv("Data and Data Cleanup/McLaughlin/Core_Community_Data2019.csv")
McL_Sites <- read.csv("Data and Data Cleanup/McLaughlin/AbioticSiteData.csv") %>%
  rename(Site = site)
McL_spp <- read.csv("Data and Data Cleanup/McLaughlin/McLaughlin_FunctionalGroups.csv") 
...
## importing the data
saro_rich <- read.csv("Data and Data Cleanup/Santa Rosa/SantaRosa_Richness.csv")
saro_cov <- read.csv("Data and Data Cleanup/Santa Rosa/SantaRosa_Cover00_06_raw.csv") 
saro_spp <- read.csv("Data and Data Cleanup/Santa Rosa/SantaRosa_SpeciesList.csv") %>%
