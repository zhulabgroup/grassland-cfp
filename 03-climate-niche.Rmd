...
write_rds(gbif_cfp_tbl, "data/occurrence/gbif/gbif-cfp-2022-07-12.rds")
...
```{r, eval=FALSE}
read_rds("data/occurrence/gbif/gbif-cfp-2022-07-12.rds") %>%
  ...
  write_rds("data/occurrence/gbif/gbif-consolidated-2022-07-12.rds")
```
...
read_rds(gbif_file) %>%
  ...
  write_rds("data/occurrence/inat/inat-cfp-2022-07-12.rds")
```
...
bind_cols(
  ...
  write_rds("data/climate/climate-gbif-2022-07-12.rds")
```
...
```{r, eval=FALSE}
# runtime ~= 4 min
pdf("figures/species-climate-niche-2022-07-12.pdf", width = 8, height = 8 * .618)
print(niche_gg)
dev.off()
```
...
niche_tbl %>%
  ...
  write_rds("data/occurrence/niche-estimates-cfp-2022-07-12.rds")
```
...
sp_sum_tbl %>%
  ...
  write_rds("data/occurrence/niche-estimates-cfp-2022-07-12-thin.rds")
