...
Test for nicer maps using the `rnaturalearth` package. First, install the development version of the package and its data.
...
rnaturalearth::ne_download(
  ...
  type = "states",
  category = "cultural",
  destdir = "data/occurrence/rnaturalearth/",
  load = FALSE,
  returnclass = "sf"
)
```

Third, read the data and make maps.

```{r}
ne_states_sf <- sf::st_read("data/occurrence/rnaturalearth/ne_50m_admin_1_states_provinces_lakes.shp")
...
write_rds(gbif_occ_df, "data/occurrence/gbif/all-spp-cfp-2022-05-02.rds")
```
