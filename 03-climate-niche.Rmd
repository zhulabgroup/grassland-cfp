...
write_rds(gbif_cfp_tbl, "data/occurrence/gbif/gbif-cfp-2022-05-10.rds")
...
for (param in param_list) {
  ...
  terraclim_ras<-terraclim_ras_list %>% stack() %>% mean()
...
clim_gbif_tbl_compare<-bind_rows(clim_gbif_tbl %>% 
                                   dplyr::select(tmp1=chelsa_tmp,
                                                 tmp2=prism_tmp,
                                                 ppt1=chelsa_ppt,
                                                 ppt2=prism_ppt,
                                                 vpd1=chelsa_vpd,
