...
```{r kai-niche-mean-sd, fig.cap="Species climate niches; black: mean and standard error, red: upper temp (hot) limit and lower precip (dry) limit"}
(niche_tbl %>%
  ...
  geom_point(aes(tmean_occ_upr, ppt_occ_lwr), col = "red", alpha = .5) + # hot and dry limits, suggested by Susan Harrison
  labs(
