...
spp_consol_tbl <- read_csv("data/occurrence/species-consolidation-2022-06-13.csv", col_types = "c")
...
write_rds(gbif_cfp_tbl, "data/occurrence/gbif/gbif-cfp-2022-06-13.rds")
...
```{r, eval=FALSE}
read_rds("data/occurrence/gbif/gbif-cfp-2022-06-13.rds") %>%
  ...
  write_rds("data/occurrence/gbif/gbif-consolidated-2022-06-13.rds")
```

Pointer to file name.

```{r}
gbif_file <- "data/occurrence/gbif/gbif-consolidated-2022-06-13.rds"
```
...
read_rds(gbif_file) %>%
  ...
  write_rds("data/occurrence/inat/inat-cfp-2022-06-13.rds")
```

Pointer to file name.

```{r}
inat_file <- "data/occurrence/inat/inat-cfp-2022-06-13.rds"
```
...
bind_cols(
  ...
  write_rds("data/climate/climate-gbif-2022-06-13.rds")
```

Pointer to file name.

```{r}
clim_file <- "data/climate/climate-gbif-2022-06-13.rds"
```
...
```{r, eval=FALSE}
# runtime ~= 4 min
pdf("figures/species-climate-niche-2022-06-13.pdf", width = 8, height = 8 * .618)
print(niche_gg)
dev.off()
```
...
niche_tbl %>%
  ...
  write_rds("data/occurrence/niche-estimates-cfp-2022-06-13.rds")
```
