...
bind_cols(
  ...
  write_rds("data/climate/climate-gbif-2022-05-10.rds")
```
...
```{r, eval=FALSE}
clim_long_sf <- read_rds("data/climate/climate-gbif-2022-05-10.rds") %>%
  pivot_longer(
...
niche_tbl %>%
  select(
    species, occ_n,
    tmp_occ_mean, tmp_occ_median, tmp_occ_sd,
    ppt_occ_mean, ppt_occ_median, ppt_occ_sd,
    vpd_occ_mean, vpd_occ_median, vpd_occ_sd
  ) %>%
