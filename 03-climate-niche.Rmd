...
```{r}
gbif_file <- "data/occurrence/gbif/gbif-consolidated-2022-06-08.rds"
```
...
read_rds(gbif_file) %>%
  ...
  write_rds("data/occurrence/inat/inat-cfp-2022-06-08.rds")
```

Pointer to file name.

```{r}
inat_file <- "data/occurrence/inat/inat-cfp-2022-06-08.rds"
```
...
```{r}
cch_file <- "data/occurrence/cch/cch-cfp-2022-05-02.rds"
```
...
bind_cols(
  ...
  write_rds("data/climate/climate-gbif-2022-06-08.rds")
```

Pointer to file name.

```{r}
clim_file <- "data/climate/climate-gbif-2022-06-08.rds"
```
...
```{r, eval=FALSE}
# runtime ~= 4 min
pdf("figures/species-climate-niche-2022-06-08.pdf", width = 8, height = 8 * .618)
print(niche_gg)
dev.off()
```
...
niche_tbl %>%
  ...
  write_rds("data/occurrence/niche-estimates-cfp-2022-06-08.rds")
```
