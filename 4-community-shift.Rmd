...
```{r mclexp-cti-watering, fig.cap="Community Temperature Index (CTI) statistics responde to watering treatments}
...
```{r mclexp-cpi-watering, fig.cap="Community Precipitation Index (CPI) statistics responde to watering treatments}
...
```{r mclexp-cvi-watering, fig.cap="Community VPD Index (CVI) statistics responde to watering treatments}
...
```{r mclexp-cti-drought, fig.cap="Community Temperature Index (CTI) statistics responde to drought treatments}
...
```{r mclexp-cpi-drought, fig.cap="Community Precipitation Index (CPI) statistics responde to drought treatments}
...
```{r mclexp-cvi-drought, fig.cap="Community VPD Index (CVI) statistics responde to drought treatments}
