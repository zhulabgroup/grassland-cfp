...
To estimate the overall trend across all observational sites or the overall effect of treatments across all years in the experiment, we further fitted weighted linear mixed-effects models with a random intercept for each site or year, respectively.
...
To estimate the overall trend across all observational sites or the overall effect of treatments across all years in the experiment, we further fitted  linear mixed-effects models with a random intercept and random intercept for each site or a random intercept for each year, respectively. 
