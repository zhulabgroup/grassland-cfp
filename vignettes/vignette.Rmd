...
df_optima_change_obs %>% knitr::kable(
  caption = "__Table 3.__ Trends of species' temperature optima (T, °C) and precipitation optima (P, mm) across observational sites, reporting the linear regression slope estimate, standard error, *p*-value, and significance level from *t*-test (ns: *p* $\\gt$ 0.05, $*$: *p* $\\leq$ 0.05, $**$: *p* $\\leq$ 0.01, $***$: *p* $\\leq$ 0.001).",
  table.attr = 'style="margin-left: auto; margin-right: auto; text-align: left;"'
)
