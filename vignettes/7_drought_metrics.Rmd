...
gg_community_index_obs_cwd_landsc <- plot_community_index(option = "obs", dat_index = dat_index_cwd, layout = "landsc")
# gg_community_index_obs_cwd_landsc
...
save_figure(out = list(
  ...
  community_index_obs_cwd_landsc = gg_community_index_obs_cwd_landsc,
